...
document.getElementById("age-input").oninput = () => {
    let userAge = document.getElementById("age-input").value;
    let outputString = "";
...
document.getElementById("bet-input-2").oninput = () => {
    let bet = document.getElementById("bet-input-2").value;
    let outputString = "";
...
document.getElementById("bet-input-3").oninput = () => {
    let bet = document.getElementById("bet-input-3").value.toUpperCase();
    let outputString = "";
...
document.getElementById("opg6-submit").onclick = () => {
    let userAge = document.getElementById("age-input-2").value;
    let travelDistance = document.getElementById("distance-input").value;
